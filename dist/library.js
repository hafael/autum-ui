...
function render$q(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock("div", null, [
    ($props.as == 'button')
      ? (vue.openBlock(), vue.createElementBlock("button", _hoisted_1$b, [
        ...
        : (vue.openBlock(), vue.createBlock(_component_inertia_link, {
            ...
            default: vue.withCtx(() => [
              vue.createElementVNode("div", _hoisted_7$4, [
                ($options.hasIcon)
                  ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_8$4, [
                      vue.renderSlot(_ctx.$slots, "icon")
                    ]))
                  : vue.createCommentVNode("v-if", true),
                vue.renderSlot(_ctx.$slots, "default")
...
const _hoisted_9$3 = /*#__PURE__*/vue.createTextVNode(" Área do Gerente ");
const _hoisted_10$3 = /*#__PURE__*/vue.createTextVNode(" Área Administrativa ");
const _hoisted_11$2 = /*#__PURE__*/vue.createTextVNode(" Meu Perfil ");
const _hoisted_12$2 = /*#__PURE__*/vue.createTextVNode(" Meus Contatos ");
const _hoisted_13$2 = /*#__PURE__*/vue.createTextVNode(" API ");
  ...
  return (vue.openBlock(), vue.createBlock(_component_jet_dropdown, {
    ...
    trigger: vue.withCtx(() => [
      (_ctx.$page.props.jetstream.managesProfilePhotos)
        ? (vue.openBlock(), vue.createElementBlock("button", _hoisted_1$a, [
        ...
        : (vue.openBlock(), vue.createElementBlock("span", _hoisted_3$7, [
            vue.createElementVNode("button", _hoisted_4$5, [
    ...
    content: vue.withCtx(() => [
      ...
      vue.createElementVNode("div", _hoisted_6$3, [
        vue.createElementVNode("span", _hoisted_7$3, vue.toDisplayString(_ctx.$page.props.user.name) + " " + vue.toDisplayString(_ctx.$page.props.user.lastname), 1 /* TEXT */),
        vue.createElementVNode("strong", _hoisted_8$3, "@" + vue.toDisplayString(_ctx.$page.props.user.username), 1 /* TEXT */)
      ]),
...
const _hoisted_2$8 = /*#__PURE__*/vue.createElementVNode("span", { class: "w-full h-full rounded-full bg-blue-200 dark:bg-blue-400 animate-ping absolute top-0 left-0" }, null, -1 /* HOISTED */);
const _hoisted_3$6 = /*#__PURE__*/vue.createElementVNode("span", { class: "w-3 h-3 rounded-full bg-blue-400 dark:bg-blue-600 absolute top-0 left-0" }, null, -1 /* HOISTED */);
const _hoisted_4$4 = [
  _hoisted_2$8,
  _hoisted_3$6
];
...
function render$a(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock("button", {
    ...
    vue.withDirectives(vue.createElementVNode("span", _hoisted_1$9, _hoisted_4$4, 512 /* NEED_PATCH */), [
...
const _hoisted_2$7 = /*#__PURE__*/vue.createElementVNode("div", { class: "absolute inset-0 bg-gray-500 opacity-75" }, null, -1 /* HOISTED */);
const _hoisted_3$5 = [
  _hoisted_2$7
];
...
const _hoisted_3$3 = /*#__PURE__*/vue.createElementVNode("h3", { class: "text-md uppercase text-gray-400" }, "Notificações", -1 /* HOISTED */);
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$4, [
    ...
    vue.withDirectives(vue.createElementVNode("p", _hoisted_4$2, "Nenhuma notificação nova.", 512 /* NEED_PATCH */), [
        ...
        return (vue.openBlock(), vue.createElementBlock("div", {
          ...
          vue.createElementVNode("div", _hoisted_10$2, [
            vue.createElementVNode("div", null, [
              vue.createElementVNode("h3", _hoisted_11$1, vue.toDisplayString(notification.data.subject), 1 /* TEXT */),
              vue.createElementVNode("p", _hoisted_12$1, vue.toDisplayString(notification.data.greeting), 1 /* TEXT */)
            ]),
...
const _hoisted_1$3 = /*#__PURE__*/vue.createElementVNode("meta", {
  "head-key": "description",
  name: "description",
  content: "Autum é uma empresa de serviços financeiros disruptivos em blockchain com sede na cidade do Rio de Janeiro."
}, null, -1 /* HOISTED */);
const _hoisted_2$2 = /*#__PURE__*/vue.createElementVNode("meta", {
  name: "author",
  content: "Autum"
}, null, -1 /* HOISTED */);
const _hoisted_3$2 = /*#__PURE__*/vue.createElementVNode("meta", {
  name: "copyright",
  content: "Autum"
}, null, -1 /* HOISTED */);
const _hoisted_4$1 = /*#__PURE__*/vue.createElementVNode("meta", {
  name: "application-name",
  content: "Wallet"
}, null, -1 /* HOISTED */);
const _hoisted_5$1 = ["content"];
const _hoisted_6$1 = /*#__PURE__*/vue.createElementVNode("meta", {
  property: "og:site_name",
  content: "Autum Wallet"
}, null, -1 /* HOISTED */);
const _hoisted_7$1 = /*#__PURE__*/vue.createElementVNode("meta", {
  property: "og:type",
  content: "website"
}, null, -1 /* HOISTED */);
const _hoisted_8$1 = /*#__PURE__*/vue.createElementVNode("meta", {
  property: "og:locale",
  content: "pt_BR"
}, null, -1 /* HOISTED */);
const _hoisted_9$1 = /*#__PURE__*/vue.createElementVNode("meta", {
  property: "og:image",
  content: "/images/autum-og-image-default.jpg"
}, null, -1 /* HOISTED */);
const _hoisted_10$1 = ["content"];
const _hoisted_11 = ["content"];
const _hoisted_12 = /*#__PURE__*/vue.createElementVNode("meta", {
  name: "twitter:card",
  content: "summary"
}, null, -1 /* HOISTED */);
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", null, [
    vue.createElementVNode("p", _hoisted_1$2, vue.toDisplayString($props.message), 1 /* TEXT */)
  ], 512 /* NEED_PATCH */)), [
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("label", _hoisted_1$1, [
    ($props.value)
      ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2$1, vue.toDisplayString($props.value), 1 /* TEXT */))
...
const _hoisted_7 = /*#__PURE__*/vue.createTextVNode(" Prever ");
const _hoisted_8 = ["src"];
const _hoisted_9 = ["src"];
const _hoisted_10 = /*#__PURE__*/vue.createTextVNode(" Fechar ");
