import { openBlock, createBlock, createVNode, resolveComponent, createElementBlock, withDirectives, createElementVNode, vShow, onMounted, onUnmounted, Teleport, Transition, withCtx, normalizeClass, renderSlot, createCommentVNode, Fragment, renderList, toDisplayString, createTextVNode } from 'vue';
...
const _hoisted_2$5 = /*#__PURE__*/createElementVNode("span", { class: "w-full h-full rounded-full bg-blue-200 dark:bg-blue-400 animate-ping absolute top-0 left-0" }, null, -1 /* HOISTED */);
const _hoisted_3$3 = /*#__PURE__*/createElementVNode("span", { class: "w-3 h-3 rounded-full bg-blue-400 dark:bg-blue-600 absolute top-0 left-0" }, null, -1 /* HOISTED */);
const _hoisted_4$2 = [
  _hoisted_2$5,
  _hoisted_3$3
];
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("button", {
    ...
    withDirectives(createElementVNode("span", _hoisted_1$5, _hoisted_4$2, 512 /* NEED_PATCH */), [
...
const _hoisted_2$4 = /*#__PURE__*/createElementVNode("div", { class: "absolute inset-0 bg-gray-500 opacity-75" }, null, -1 /* HOISTED */);
const _hoisted_3$2 = [
  _hoisted_2$4
];
...
const _hoisted_3 = /*#__PURE__*/createElementVNode("h3", { class: "text-md uppercase text-gray-400" }, "Notificações", -1 /* HOISTED */);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    withDirectives(createElementVNode("p", _hoisted_4, "Nenhuma notificação nova.", 512 /* NEED_PATCH */), [
        ...
        return (openBlock(), createElementBlock("div", {
          ...
          createElementVNode("div", _hoisted_10, [
            createElementVNode("div", null, [
              createElementVNode("h3", _hoisted_11, toDisplayString(notification.data.subject), 1 /* TEXT */),
              createElementVNode("p", _hoisted_12, toDisplayString(notification.data.greeting), 1 /* TEXT */)
            ]),
            createElementVNode("div", _hoisted_13, [
              createElementVNode("p", _hoisted_14, toDisplayString(_ctx.$filters.fromDateTime(notification.created_at, 'd/m/Y')), 1 /* TEXT */),
              createElementVNode("p", _hoisted_15, toDisplayString(_ctx.$filters.fromDateTime(notification.created_at, 'HH:mm')), 1 /* TEXT */)
            ])
          ])
        ], 8 /* PROPS */, _hoisted_6))
      }), 128 /* KEYED_FRAGMENT */))
