...
function render$Y(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", null, [
    ($props.as == 'button')
      ? (openBlock(), createElementBlock("button", _hoisted_1$G, [
...
const _hoisted_5$7 = /*#__PURE__*/createElementVNode("svg", {
...
const _hoisted_9$4 = /*#__PURE__*/createTextVNode(" Área do Gerente ");
const _hoisted_10$4 = /*#__PURE__*/createTextVNode(" Área Administrativa ");
const _hoisted_11$3 = /*#__PURE__*/createTextVNode(" Meu Perfil ");
const _hoisted_12$3 = /*#__PURE__*/createTextVNode(" Meus Contatos ");
const _hoisted_13$3 = /*#__PURE__*/createTextVNode(" API ");
  ...
  return (openBlock(), createBlock(_component_jet_dropdown, {
    ...
    trigger: withCtx(() => [
      (_ctx.$page.props.jetstream.managesProfilePhotos)
        ? (openBlock(), createElementBlock("button", _hoisted_1$F, [
        ...
        : (openBlock(), createElementBlock("span", _hoisted_3$l, [
            createElementVNode("button", _hoisted_4$e, [
    ...
    content: withCtx(() => [
      ...
      createElementVNode("div", _hoisted_6$6, [
        createElementVNode("span", _hoisted_7$5, toDisplayString(_ctx.$page.props.user.name) + " " + toDisplayString(_ctx.$page.props.user.lastname), 1 /* TEXT */),
        createElementVNode("strong", _hoisted_8$4, "@" + toDisplayString(_ctx.$page.props.user.username), 1 /* TEXT */)
      ]),
...
const _hoisted_2$r = /*#__PURE__*/createElementVNode("span", { class: "w-full h-full rounded-full bg-blue-200 dark:bg-blue-400 animate-ping absolute top-0 left-0" }, null, -1 /* HOISTED */);
const _hoisted_3$k = /*#__PURE__*/createElementVNode("span", { class: "w-3 h-3 rounded-full bg-blue-400 dark:bg-blue-600 absolute top-0 left-0" }, null, -1 /* HOISTED */);
const _hoisted_4$d = [
  _hoisted_2$r,
  _hoisted_3$k
];
...
function render$G(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("button", {
    ...
    withDirectives(createElementVNode("span", _hoisted_1$E, _hoisted_4$d, 512 /* NEED_PATCH */), [
...
const _hoisted_2$q = /*#__PURE__*/createElementVNode("div", { class: "absolute inset-0 bg-gray-500 opacity-75" }, null, -1 /* HOISTED */);
const _hoisted_3$j = [
  _hoisted_2$q
];
...
const _hoisted_3$h = /*#__PURE__*/createElementVNode("h3", { class: "text-md uppercase text-gray-400" }, "Notificações", -1 /* HOISTED */);
...
function render$B(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", _hoisted_1$z, [
    ...
    withDirectives(createElementVNode("p", _hoisted_4$b, "Nenhuma notificação nova.", 512 /* NEED_PATCH */), [
        ...
        return (openBlock(), createElementBlock("div", {
          ...
          createElementVNode("div", _hoisted_10$3, [
            createElementVNode("div", null, [
              createElementVNode("h3", _hoisted_11$2, toDisplayString(notification.data.subject), 1 /* TEXT */),
              createElementVNode("p", _hoisted_12$2, toDisplayString(notification.data.greeting), 1 /* TEXT */)
            ]),
...
const _hoisted_1$y = /*#__PURE__*/createElementVNode("meta", {
  "head-key": "description",
  name: "description",
  content: "Autum é uma empresa de serviços financeiros disruptivos em blockchain com sede na cidade do Rio de Janeiro."
}, null, -1 /* HOISTED */);
const _hoisted_2$l = /*#__PURE__*/createElementVNode("meta", {
  name: "author",
  content: "Autum"
}, null, -1 /* HOISTED */);
const _hoisted_3$g = /*#__PURE__*/createElementVNode("meta", {
  name: "copyright",
  content: "Autum"
}, null, -1 /* HOISTED */);
const _hoisted_4$a = /*#__PURE__*/createElementVNode("meta", {
  name: "application-name",
  content: "Wallet"
}, null, -1 /* HOISTED */);
const _hoisted_5$5 = ["content"];
const _hoisted_6$4 = /*#__PURE__*/createElementVNode("meta", {
  property: "og:site_name",
  content: "Autum Wallet"
}, null, -1 /* HOISTED */);
const _hoisted_7$3 = /*#__PURE__*/createElementVNode("meta", {
  property: "og:type",
  content: "website"
}, null, -1 /* HOISTED */);
const _hoisted_8$2 = /*#__PURE__*/createElementVNode("meta", {
  property: "og:locale",
  content: "pt_BR"
}, null, -1 /* HOISTED */);
const _hoisted_9$2 = /*#__PURE__*/createElementVNode("meta", {
  property: "og:image",
  content: "/images/autum-og-image-default.jpg"
}, null, -1 /* HOISTED */);
const _hoisted_10$2 = ["content"];
const _hoisted_11$1 = ["content"];
const _hoisted_12$1 = /*#__PURE__*/createElementVNode("meta", {
  name: "twitter:card",
  content: "summary"
}, null, -1 /* HOISTED */);
...
function render$y(_ctx, _cache, $props, $setup, $data, $options) {
  return withDirectives((openBlock(), createElementBlock("div", null, [
    createElementVNode("p", _hoisted_1$x, toDisplayString($props.message), 1 /* TEXT */)
  ], 512 /* NEED_PATCH */)), [
    [vShow, $props.message]
  ])
}
...
function render$x(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("label", _hoisted_1$w, [
    ($props.value)
      ? (openBlock(), createElementBlock("span", _hoisted_2$k, toDisplayString($props.value), 1 /* TEXT */))
...
const _hoisted_7$2 = /*#__PURE__*/createTextVNode(" Prever ");
const _hoisted_8$1 = ["src"];
const _hoisted_9$1 = ["src"];
const _hoisted_10$1 = /*#__PURE__*/createTextVNode(" Fechar ");
...
function render$u(_ctx, _cache) {
  return (openBlock(), createElementBlock("div", _hoisted_1$t, [
    createElementVNode("div", _hoisted_2$i, [
      createElementVNode("h3", _hoisted_3$d, [
        renderSlot(_ctx.$slots, "title")
      ]),
...
function render$t(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", {
    class: normalizeClass(["md:grid md:grid-cols-3 md:gap-6", {'lg:grid-cols-1 lg:gap-3': $props.responsive}])
  }, [
    createVNode(_component_jet_section_title, null, {
      title: withCtx(() => [
        renderSlot(_ctx.$slots, "title")
      ]),
      description: withCtx(() => [
    ...
    createElementVNode("div", _hoisted_1$s, [
      createElementVNode("div", {
        class: normalizeClass(["px-4 py-5 sm:p-6 bg-white dark:bg-gray-900 text-gray-300 shadow", $options.hasActions ? 'sm:rounded-tl-md sm:rounded-tr-md' : 'sm:rounded-md'])
      }, [
        renderSlot(_ctx.$slots, "content")
      ], 2 /* CLASS */),
      ($options.hasActions)
...
function render$r(_ctx, _cache) {
  return (openBlock(), createElementBlock("img", _hoisted_1$q))
}
...
const _hoisted_1$o = /*#__PURE__*/createElementVNode("img", {
  class: "w-16 h-16",
  src: "/img/autum-logo-color.png",
  alt: "Autum Wallet brand logo"
}, null, -1 /* HOISTED */);
...
function render$p(_ctx, _cache) {
  ...
  return (openBlock(), createBlock(_component_inertia_link, { href: '/' }, {
    default: withCtx(() => [
      _hoisted_1$o
    ]),
    _: 1 /* STABLE */
...
const _hoisted_12 = /*#__PURE__*/createElementVNode("svg", {
  class: "h-5 w-5 text-white",
  xmlns: "http://www.w3.org/2000/svg",
  fill: "none",
  viewBox: "0 0 24 24",
...
function render$o(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("div", null, [
    ($data.show && $options.message)
      ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: normalizeClass({ 'bg-indigo-500': $options.style == 'success', 'bg-red-700': $options.style == 'danger' })
        }, [
          createElementVNode("div", _hoisted_1$n, [
            createElementVNode("div", _hoisted_2$f, [
              createElementVNode("div", _hoisted_3$c, [
                createElementVNode("span", {
                  class: normalizeClass(["flex p-2 rounded-lg", { 'bg-indigo-600': $options.style == 'success', 'bg-red-600': $options.style == 'danger' }])
                }, [
                  ($options.style == 'success')
                    ? (openBlock(), createElementBlock("svg", _hoisted_4$7, _hoisted_6$2))
                    : createCommentVNode("v-if", true),
                  ($options.style == 'danger')
                    ? (openBlock(), createElementBlock("svg", _hoisted_7$1, _hoisted_9))
                    : createCommentVNode("v-if", true)
                ], 2 /* CLASS */),
                createElementVNode("p", _hoisted_10, toDisplayString($options.message), 1 /* TEXT */)
              ]),
              createElementVNode("div", _hoisted_11, [
                createElementVNode("button", {
                  type: "button",
                  class: normalizeClass(["-mr-1 flex p-2 rounded-md focus:outline-none sm:-mr-2 transition", { 'hover:bg-indigo-600 focus:bg-indigo-600': $options.style == 'success', 'hover:bg-red-600 focus:bg-red-600': $options.style == 'danger' }]),
                  "aria-label": "Dismiss",
                  onClick: _cache[0] || (_cache[0] = withModifiers($event => ($data.show = false), ["prevent"]))
                }, _hoisted_13, 2 /* CLASS */)
              ])
            ])
          ])
...
const _hoisted_3$b = /*#__PURE__*/createElementVNode("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10" }, [
...
function render$l(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (!$props.mask)
    ? (openBlock(), createElementBlock("input", {
        key: 0,
        class: normalizeClass(["border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600 dark:focus:ring-indigo-400", {
    ...
    createVNode(_component_jet_dialog_modal, {
      ...
      footer: withCtx(() => [
        createVNode(_component_jet_secondary_button, { onClick: $options.closeModal }, {
          default: withCtx(() => [
            createTextVNode(toDisplayString(_ctx.__('Cancel')), 1 /* TEXT */)
          ]),
          _: 1 /* STABLE */
        }, 8 /* PROPS */, ["onClick"]),
        createVNode(_component_jet_button, {
          class: normalizeClass(["ml-2", { 'opacity-25': $data.form.processing }]),
          onClick: $options.confirmPassword,
          disabled: $data.form.processing
        }, {
          default: withCtx(() => [
            createTextVNode(toDisplayString($props.button), 1 /* TEXT */)
          ]),
          _: 1 /* STABLE */
  ...
  return (openBlock(), createElementBlock("div", {
    ...
    createElementVNode("div", _hoisted_1$g, [
      createElementVNode("form", {
        ...
        createElementVNode("div", {
          class: normalizeClass(["px-4 py-5 bg-white sm:p-6 dark:bg-gray-900 shadow", $options.hasActions ? 'sm:rounded-tl-md sm:rounded-tr-md' : 'sm:rounded-md'])
        }, [
...
const _hoisted_1$f = /*#__PURE__*/createTextVNode(" Oops... ");
...
function render$g(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock(Fragment, null, [
    createCommentVNode(" Payment Error Modal "),
    createVNode(_component_jet_dialog_modal, {
      show: $props.show,
      ...
      content: withCtx(() => [
        createElementVNode("h3", _hoisted_2$b, toDisplayString($props.heading), 1 /* TEXT */),
        createElementVNode("p", _hoisted_3$9, toDisplayString($props.response.message), 1 /* TEXT */),
        ($props.response.errors)
          ? (openBlock(), createElementBlock("ul", _hoisted_4$5, [
              (openBlock(true), createElementBlock(Fragment, null, renderList($props.response.errors, (error, idx) => {
                return (openBlock(), createElementBlock("li", {
                  key: idx,
                  class: "text-red-600 flex flex-col py-1 break-words"
                }, [
                  createCommentVNode(" <strong class=\"text-bold\">{{ __(idx) }}:</strong> "),
                  (openBlock(true), createElementBlock(Fragment, null, renderList(error, (message) => {
                    return (openBlock(), createElementBlock("span", { key: message }, toDisplayString(message), 1 /* TEXT */))
                  }), 128 /* KEYED_FRAGMENT */))
                ]))
              }), 128 /* KEYED_FRAGMENT */))
            ]))
      ...
      footer: withCtx(() => [
        createVNode(_component_jet_secondary_button, {
          ...
          default: withCtx(() => [
            createTextVNode(toDisplayString($props.closeText), 1 /* TEXT */)
          ]),
          _: 1 /* STABLE */
        })
      ]),
...
function render$e(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", _hoisted_1$d, [
    withDirectives(createElementVNode("input", {
      ...
      class: normalizeClass([$props.inputClass, "border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm py-6 pr-10 w-full"]),
    ...
    createElementVNode("div", {
      ...
      (!$data.visibility)
        ? (openBlock(), createBlock(_component_EyeOffIcon, {
            key: 0,
            class: "w-5 h-5"
          }))
...
const _hoisted_1$c = /*#__PURE__*/createTextVNode(" Código PIN ");
const _hoisted_2$9 = /*#__PURE__*/createElementVNode("h3", { class: "text-lg font-semibold mb-3" }, "Autorize esta ação com o código PIN", -1 /* HOISTED */);
  ...
  return (openBlock(), createElementBlock(Fragment, null, [
    ...
    createVNode(_component_jet_dialog_modal, {
      ...
      content: withCtx(() => [
        ...
        createCommentVNode(" <jet-input-pin v-model=\"pin_number\" @input=\"$emit('input', pin_number)\" /> "),
        createElementVNode("form", {
          id: "enter-pin",
          class: "flex flex-row flex-wrap justify-center space-x-2",
          onSubmit: _cache[1] || (_cache[1] = withModifiers($event => (_ctx.handleSubmit()), ["prevent"])),
          onPaste: _cache[2] || (_cache[2] = withModifiers($event => ($options.handlePaste($event)), ["prevent"])),
          ref: "pinFormRef",
          autocomplete: "off"
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(Array.from({ length: $data.length }), (input, index) => {
            return (openBlock(), createElementBlock("input", {
              key: index,
              onInput: _cache[0] || (_cache[0] = withModifiers($event => ($options.handleInput($event.target)), ["prevent"])),
              onKeydown: [
                withKeys($event => ($event.target.value || $options.focusPreviousRef(index)), ["backspace"]),
                withKeys($event => ($event.target.value || $options.focusPreviousRef(index)), ["delete"])
              ],
        ...
        withDirectives(createElementVNode("p", _hoisted_4$4, " O PIN informado é inválido. ", 512 /* NEED_PATCH */), [
          [vShow, $data.invalid]
        ])
      ]),
      footer: withCtx(() => [
        ...
        createVNode(_component_jet_button, {
          ...
          default: withCtx(() => [
            (!$data.loading)
              ? (openBlock(), createElementBlock("span", _hoisted_5, toDisplayString($props.authorizeText), 1 /* TEXT */))
              : (openBlock(), createElementBlock("span", _hoisted_6, "Aguarde..."))
          ]),
          _: 1 /* STABLE */
        }, 8 /* PROPS */, ["onClick", "disabled"])
      ]),
...
const _hoisted_1$b = /*#__PURE__*/createTextVNode(" Importar Carteira ");
const _hoisted_2$8 = { class: "col-span-6 sm:col-span-4" };
const _hoisted_3$7 = { class: "font-bold" };
const _hoisted_4$3 = /*#__PURE__*/createTextVNode(" de 25 palavras.");
...
function render$c(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_jet_button = resolveComponent("jet-button");
  const _component_jet_dialog_modal = resolveComponent("jet-dialog-modal");
  const _component_jet_pin_request_dialog_modal = resolveComponent("jet-pin-request-dialog-modal");
  const _component_jet_http_error_dialog_modal = resolveComponent("jet-http-error-dialog-modal");
  ...
  return (openBlock(), createElementBlock(Fragment, null, [
    ...
    createVNode(_component_jet_dialog_modal, {
      ...
      content: withCtx(() => [
        createCommentVNode(" Wallet Mnemonic "),
        createElementVNode("div", _hoisted_2$8, [
          ...
          createElementVNode("div", {
            class: normalizeClass(["text-gray-700 text-xs mt-1", {'text-green-600': $options.wordsInSentence === 25, 'text-red-600': $options.wordsInSentence !== 25}])
          }, [
            createElementVNode("span", _hoisted_3$7, toDisplayString($options.wordsInSentence), 1 /* TEXT */),
            _hoisted_4$3
          ], 2 /* CLASS */)
        ])
      ]),
      footer: withCtx(() => [
        ...
        createVNode(_component_jet_button, {
          ...
          default: withCtx(() => [
            createTextVNode(toDisplayString($props.importText), 1 /* TEXT */)
          ]),
          _: 1 /* STABLE */
        })
      ]),
    ...
    createVNode(_component_jet_pin_request_dialog_modal, {
    ...
    createVNode(_component_jet_http_error_dialog_modal, {
      show: $data.hasError,
...
function render$b(_ctx, _cache, $props, $setup, $data, $options) {
  const _directive_money = resolveDirective("money");
...
function render$a(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", _hoisted_1$9, [
    createElementVNode("input", {
      type: $options.attrType,
      class: normalizeClass([$props.inputClass, "border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm pr-10 w-full dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600 dark:focus:ring-indigo-400"]),
      value: $props.modelValue,
      onInput: _cache[0] || (_cache[0] = $event => (_ctx.$emit('update:modelValue', $event.target.value))),
...
const _hoisted_2$6 = /*#__PURE__*/createElementVNode("circle", {
  class: "opacity-25",
  cx: "12",
  cy: "12",
  r: "10",
...
function render$9(_ctx, _cache, $props, $setup, $data, $options) {
  return withDirectives((openBlock(), createElementBlock("svg", _hoisted_1$8, _hoisted_4$2, 512 /* NEED_PATCH */)), [
    [vShow, $props.show]
  ])
}
...
const _hoisted_1$7 = /*#__PURE__*/createTextVNode(" Definir código PIN ");
const _hoisted_2$5 = /*#__PURE__*/createElementVNode("p", { class: "text-red-600 mb-2" }, "É necessário definir um código PIN para realizar essa ação.", -1 /* HOISTED */);
const _hoisted_3$5 = /*#__PURE__*/createElementVNode("p", null, "Essa é uma medida de segurança para previnir ações não autorizadas a partir da sua conta.", -1 /* HOISTED */);
const _hoisted_4$1 = /*#__PURE__*/createTextVNode(" Definir PIN ");
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("label", {
    for: $props.id,
    class: normalizeClass(["text-sm text-gray-700 flex content-center", {'text-gray-400 mouse-disabled': $props.disabled}])
  }, [
    withDirectives(createElementVNode("input", {
      type: "radio",
      value: $props.value,
      ...
      "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => (($options.proxyChecked) = $event)),
      disabled: $props.disabled,
      class: normalizeClass(["rounded-full border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 mr-1", {'opacity-50': $props.disabled}])
    }, null, 10 /* CLASS, PROPS */, _hoisted_2$4), [
      [vModelRadio, $options.proxyChecked]
    ]),
    ($props.placeholder)
      ? (openBlock(), createElementBlock("span", _hoisted_3$4, toDisplayString($props.placeholder), 1 /* TEXT */))
      : createCommentVNode("v-if", true)
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", null, [
    ($props.as == 'button')
      ? (openBlock(), createElementBlock("button", {
          key: 0,
          class: normalizeClass([$options.classes, "w-full text-left"])
        }, [
...
const _hoisted_2$2 = /*#__PURE__*/createElementVNode("div", { class: "py-8" }, [
  /*#__PURE__*/createElementVNode("div", { class: "border-t border-gray-200" })
], -1 /* HOISTED */);
const _hoisted_3$2 = [
  _hoisted_2$2
];
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("select", {
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList($props.options, (option) => {
      ...
      }, toDisplayString(option.text), 9 /* TEXT, PROPS */, _hoisted_2$1))
    }), 128 /* KEYED_FRAGMENT */))
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return ($options.hasErrors)
    ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
        createElementVNode("div", _hoisted_2, toDisplayString(_ctx.__('Whoops! Something went wrong.')), 1 /* TEXT */),
        createElementVNode("ul", _hoisted_3$1, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($options.errors, (error, key) => {
            return (openBlock(), createElementBlock("li", { key: key }, toDisplayString(error), 1 /* TEXT */))
          }), 128 /* KEYED_FRAGMENT */))
        ])
      ]))
    : createCommentVNode("v-if", true)
